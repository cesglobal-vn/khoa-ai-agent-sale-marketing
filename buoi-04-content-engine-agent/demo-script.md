...
>
> Chuẩn bị trước: mở **thư mục làm việc** của buổi 1 bằng tab **Code** của Claude Desktop. Trong thư mục phải có sẵn `CLAUDE.md`, hai file `san-pham-thao-an.md` và `review-va-tin-nhan-khach.md` chép từ `case-study/thao-an/`, và skill `viet-bai-ban-hang` ở `.claude/skills/viet-bai-ban-hang/SKILL.md`. Giao diện app có thể đổi theo phiên bản, giảng viên mở thử một lượt trước buổi.
...
tạo luôn thư mục cha nếu chưa có. Nội dung như sau: [dán khối trong system-prompt.md]
```
