...
Giả sử tên đăng nhập Windows là `Admin`, thư mục làm việc là `thao-an-workspace`.

| File | Đường dẫn đầy đủ |
|---|---|
| Skill Content Engine | `C:\Users\Admin\thao-an-workspace\.claude\skills\content-engine\SKILL.md` |
| Skill viết bài, đã có từ buổi 1 | `C:\Users\Admin\thao-an-workspace\.claude\skills\viet-bai-ban-hang\SKILL.md` |
| Hồ sơ thương hiệu, đã có từ buổi 1 | `C:\Users\Admin\thao-an-workspace\CLAUDE.md` |
