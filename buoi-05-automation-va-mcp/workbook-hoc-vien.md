...
Chưa có dữ liệu thật của mình thì dùng bộ Thảo An trong [../case-study/thao-an/](../case-study/thao-an/), vẫn hoàn thành đủ 5 sản phẩm.
...
**Bảng log bài đăng:** dùng nguyên bảng trong [luong-post-bai.md](luong-post-bai.md). Tối thiểu phải có ngày đăng, mã bài, kênh, góc nội dung, link ảnh, người duyệt, giờ đăng, link bài, kết quả sau 7 ngày, ghi chú.
...
Làm luồng post bài thì theo đúng 6 bước trong [luong-post-bai.md](luong-post-bai.md). Dán chuỗi prompt này, chạy từng cái một, đừng dán cả cụm.
