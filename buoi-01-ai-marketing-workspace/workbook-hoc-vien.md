...
- [ ] Đã chọn đúng thư mục làm việc `C:\Users\<tên bạn>\thao-an-workspace`
- [ ] Claude tạo được file thật trong thư mục đó

Chưa cài xong? Mở [huong-dan-cai-dat.md](huong-dan-cai-dat.md).
...
Bí chỗ nào thì mở [system-prompt.md](system-prompt.md), phần 1 là `CLAUDE.md` mẫu hoàn chỉnh của Thảo An.
...
Điền tay vào khung 6 phần dưới. Điền càng cụ thể, skill chạy càng đúng. Mẫu đã điền đầy đủ ở [system-prompt.md](system-prompt.md) phần 2.
...
**Đặt file ở đâu:** hôm nay dùng cách 1, đặt trong thư mục làm việc, tức `C:\Users\<tên>\thao-an-workspace\.claude\skills\viet-bai-ban-hang\SKILL.md`. Muốn skill xài được ở mọi thư mục thì đặt ở `C:\Users\<tên>\.claude\skills\viet-bai-ban-hang\SKILL.md`.
...
1. Mở [case-study/thao-an/san-pham-thao-an.md](../case-study/thao-an/san-pham-thao-an.md): hồ sơ 3 SKU, giá, thành phần, công dụng, danh sách điều không được nói. Copy file đó vào thư mục `thao-an-workspace`, rồi gõ: `Đọc file san-pham-thao-an.md tôi vừa bỏ vào thư mục này.`
2. K2: lấy dữ liệu từ file đó thay vì tự nghĩ. Riêng câu định vị và 3 thông điệp vẫn phải tự viết, đó là phần luyện.
3. Bí thì mở [system-prompt.md](system-prompt.md): phần 1 là `CLAUDE.md` hoàn chỉnh của Thảo An, phần 2 là `SKILL.md` hoàn chỉnh. K3 và K4 chạy nguyên prompt trong workbook, không phải sửa gì.
