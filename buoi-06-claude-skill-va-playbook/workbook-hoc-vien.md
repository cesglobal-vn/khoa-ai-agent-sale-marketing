...
Chưa có dữ liệu thật thì dùng bộ Thảo An trong [../case-study/thao-an/](../case-study/thao-an/), vẫn nộp đủ 6 sản phẩm. Mẫu Skill hoàn chỉnh để đối chiếu nằm ở [system-prompt.md](system-prompt.md), bí chỗ nào thì mở ra xem cách viết.
