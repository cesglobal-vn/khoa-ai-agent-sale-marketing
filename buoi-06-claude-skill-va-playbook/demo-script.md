...
- Mở sẵn tab trình duyệt file [../case-study/thao-an/assets/thao-an-agent-team-diagram.html](../case-study/thao-an/assets/thao-an-agent-team-diagram.html), để tab riêng, chưa chiếu.
- Mở sẵn [system-prompt.md](system-prompt.md) để copy Skill mẫu khi cần.

> Nhắc lớp ngay từ đầu: "35 phút này các bạn xem, không làm theo. Có một đoạn ở phút 18 là phần quan trọng nhất cả buổi, tôi sẽ báo trước khi tới."
...
Một file Skill hoàn chỉnh. Bản mẫu nguyên văn nằm ở [system-prompt.md](system-prompt.md), mở ra chiếu lên cho lớp đối chiếu.
...
Chuyển sang tab trình duyệt đã mở sẵn: [../case-study/thao-an/assets/thao-an-agent-team-diagram.html](../case-study/thao-an/assets/thao-an-agent-team-diagram.html).
...
"35 phút vừa rồi tôi đi đúng 5 bước: gom tài sản, rút quy trình, viết Skill, thử Skill trên cái mới, và lên lịch 14 ngày. 65 phút tới các bạn làm y hệt trên thương hiệu của mình. Bước quan trọng nhất là bước thử Skill trên yêu cầu mới. Ai bỏ bước đó thì đừng nộp bài."
