...
> Giảng viên chạy đúng file này, chiếu màn hình, và **học viên gõ theo cùng lúc trên máy mình**, không ngồi xem. Bảng phân công học viên gõ gì ở từng mốc, cùng bốn điểm dừng chờ cả lớp, nằm ở mục "Khối 2 chạy kiểu làm theo" trong [../giao-an/buoi-02-customer-insight-agent.md](../giao-an/buoi-02-customer-insight-agent.md). Đọc mục đó trước khi vào lớp. Cả buổi chạy trong Claude Desktop, tab **Code**, mở sẵn thư mục làm việc của buổi 1.
> Dữ liệu chính: `demo/thao-an/review-va-tin-nhan-khach.md` (15 review R01-R15, 15 tin nhắn M01-M15, tổng 30 mẩu).
...
- Đã cài sẵn skill `customer-insight` theo `../demo/buoi-02/skill-customer-insight.md`, đường dẫn `.claude/skills/customer-insight/SKILL.md`, và đã chạy thử một lượt.
...
**Kết quả mong đợi:** bảng 6 đến 8 dòng. Dòng đầu là nỗi lo kích ứng và an toàn, khoảng 9/30. Đối chiếu với bảng chuẩn trong `../giao-an/buoi-02-customer-insight-agent.md`.
...
**Giao việc cho khối làm sản phẩm, 55 phút gõ chia hai chặng, giữa hai chặng có 10 phút giải lao:**
