...
Dùng nguyên bộ Thảo An: `demo/thao-an/review-va-tin-nhan-khach.md`. Có sẵn 15 review (R01-R15) và 15 tin nhắn (M01-M15), đã đánh ID. Chép file đó vào thư mục làm việc của bạn trước khi bắt đầu.
...
**1.2** Cài skill `customer-insight`. Mở file `../demo/buoi-02/skill-customer-insight.md`, copy toàn bộ phần trong code block (gồm cả ba dấu gạch và hai dòng `name`, `description`), rồi gõ vào ô nhập:
