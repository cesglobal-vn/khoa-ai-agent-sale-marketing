...
**Chưa có lead thật thì làm gì:** chép nguyên `demo/thao-an/danh-sach-lead-si.md` (10 lead) và `demo/thao-an/chinh-sach-gia-si.md` vào thư mục làm việc. Đủ để hoàn thành cả 7 sản phẩm. Đừng ngồi chờ xin data, làm trên Thảo An xong về thay dữ liệu là ra bộ của mình.
