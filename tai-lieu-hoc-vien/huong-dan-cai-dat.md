...
5. Gõ tên: `thao-an-marketing` rồi Enter. Gõ đúng chữ thường, không dấu, không khoảng trắng.

**Đường dẫn đầy đủ của bạn giờ là:** `C:\Users\<tên đăng nhập>\thao-an-marketing`
...
3. Lần đầu vào, app hỏi bạn chọn thư mục làm việc. Bấm nút chọn thư mục (nút ghi **Open folder** hoặc **Add folder**), trỏ tới `C:\Users\<tên bạn>\thao-an-marketing`, bấm **Select Folder**.
...
1. Mở **Claude Desktop**.
2. Bấm tab **Code**.
3. Kiểm tra góc màn hình đang hiện đúng thư mục `thao-an-marketing`. Sai thư mục thì bấm nút chọn thư mục, trỏ lại cho đúng.
...
- [ ] **Ô 2.** Trong tab Code, đã chọn được thư mục `C:\Users\<tên bạn>\thao-an-marketing`.
...
| Không tìm thấy thư mục vừa tạo | Vào lại C:\Users mà không thấy `thao-an-marketing` | Mở File Explorer, bấm ô địa chỉ trên cùng, gõ `%USERPROFILE%` rồi Enter. Đúng thư mục của bạn sẽ mở ra. Nhìn xem có thư mục chưa, chưa có thì tạo lại ngay tại đó. Lỗi phổ biến: lúc nãy tạo nhầm trong Downloads hoặc Desktop |
