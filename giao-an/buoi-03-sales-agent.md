...
Cộng thêm đầu ra 2 buổi trước, cũng đã nằm sẵn trong thư mục đó: **hồ sơ sản phẩm** (`san-pham-thao-an.md`), **câu định vị, 3 thông điệp, giọng văn và danh sách từ cấm** trong `CLAUDE.md`, và **bảng insight khách hàng có trích dẫn** của buổi 2 (`insight-khach-hang.md`). Không có thì lấy nguyên bộ Thảo An trong `demo/thao-an/`.
...
| 2. Demo **kiểu làm theo** | 35 phút | Giảng viên chạy trên 10 lead Thảo An: chấm điểm, 2 email khác tính chất, ca L07 độc quyền khu vực, proposal. Học viên gõ cùng lúc, không ngồi xem. **25 phút học viên tay trên bàn phím, 10 phút giảng viên nói và chỉ chỗ.** Xem mục "Khối 2 chạy kiểu làm theo" bên dưới | Lớp thấy đủ 3 skill chạy nối nhau, và mỗi máy đã chạy thử ít nhất một lượt chấm điểm |
| 3. Học viên làm, chặng 1 | 30 phút | Theo `../workbook/buoi-03-sales-agent.md`: chuẩn bị data (3 phút), bước 1 bắt agent tự khai nó thiếu gì (4 phút), bước 2 tự viết bảng tiêu chí (8 phút), bước 3 chấm điểm 10 lead (10 phút), bước 4 và 5 viết 5 email đầu (5 phút) | Bảng tiêu chí có trọng số cộng bằng 100, bảng chấm điểm 10 lead |
| **Giải lao** | **10 phút** | Nghỉ. Bắt buộc, không gộp vào khối khác. Cho nghỉ đúng sau khi mỗi người đã có tối thiểu 5 trong 10 email, đó là điểm dừng tự nhiên nhất của buổi | |
| 3. Học viên làm, chặng 2 | 25 phút | Bước 4 và 5 nốt 5 email và 10 tin nhắn còn lại (10 phút), bước 6 kịch bản gọi 5 phút (5 phút), bước 7 mười kịch bản xử lý từ chối (5 phút), bước 8 proposal nháp (5 phút) | 7 sản phẩm |
...
> **Lưu ý cho giảng viên:** con số phút ghi trong ngoặc ở từng bước của workbook tính theo nhịp cũ chưa có giải lao, cộng lại vượt quá 55 phút. Bám bảng trên. Ai không kịp thì áp mức đạt tối thiểu: **bảng chấm điểm 10 lead cộng 3 email**, phần còn lại chuyển sang bài về nhà. Đừng cắt bước 8 proposal, vì ca L07 độc quyền khu vực là chỗ dạy ranh giới agent phải dừng.
...
> "Anh chị mở thư mục làm việc ra, đặt tay lên bàn phím. Ba mươi lăm phút tới tôi gõ gì thì anh chị gõ y hệt trên máy mình. Ai chưa có 10 lead của mình thì mở bộ 10 lead sỉ Thảo An ra, chạy trên bộ đó, ra sản phẩm y hệt. Tôi đi chậm, và sau mỗi prompt lớn tôi dừng lại hỏi ai chưa ra kết quả. Giơ tay ngay lúc đó."

**Học viên gõ gì song song:**

| Giảng viên làm | Học viên gõ cùng lúc trên máy mình |
|---|---|
| Cài và gọi skill `lead-scoring`, bắt agent tự khai nó thiếu gì | Cài skill đó vào thư mục của mình, chạy đúng prompt đó trên bộ lead của mình |
| Chấm điểm 10 lead Thảo An, ra bảng có cột lý do và cột độ tin cậy | Chấm 10 lead của chính mình, hoặc 10 lead Thảo An nếu chưa có data |
| Viết 2 email khác tính chất từ ghi chú trao đổi | Viết 2 email trên đúng 2 lead của mình, rồi tự làm phép thử đổi tên |
| Chạy ca L07 độc quyền khu vực | Chạy đúng ca đó trên bộ Thảo An, xem máy mình có để trống mục đó không |
| Dựng proposal nháp | Không gõ. Đây thuộc phần 10 phút giảng viên nói và chỉ chỗ, học viên tự dựng proposal ở bước 8 của khối 3 |

**Bốn điểm dừng bắt buộc:**

1. **Sau khi skill `lead-scoring` được gọi ra lần đầu:** "Ai chưa thấy Claude gọi đúng skill thì giơ tay." Chờ hai phần ba lớp. Máy nào chưa gọi được thì kiểm đường dẫn `.claude/skills/lead-scoring/SKILL.md`.
2. **Sau khi ra bảng chấm điểm 10 lead:** "Ai chưa ra đủ 10 dòng thì giơ tay." Đây là điểm dừng dài nhất, chờ tới 90 giây. Bảng này là xương sống cả buổi.
3. **Sau 2 email đầu tiên:** "Anh chị thử đổi tên lead trong email của mình sang một lead khác. Email còn dùng được không?" Ai bảo còn dùng được thì email đó mới là mẫu điền tên, chưa đạt. Chỉ luôn cách sửa trước khi đi tiếp.
4. **Sau ca L07:** "Trên máy anh chị, agent có tự hứa một con số chiết khấu độc quyền không, hay nó để trống và ghi cần xin ý kiến?" Đếm bằng giơ tay. Máy nào tự hứa số thì chiếu lên, đó là tình huống dạy được, và sửa bằng cách thêm ràng buộc vào file chính sách giá chứ không sửa tay proposal.

**Quy tắc cứng:** thà chạy chậm mà cả lớp gõ, còn hơn chạy đúng giờ mà nửa lớp ngồi xem. Thiếu giờ thì bỏ phần dựng proposal trong demo, không bỏ điểm dừng nào.
...
Ba file nằm ở `.claude/skills/lead-scoring/SKILL.md`, `.claude/skills/soan-proposal/SKILL.md`, `.claude/skills/theo-duoi-chot-don/SKILL.md`. Nội dung đầy đủ trong `../demo/buoi-03/skill-sales-3-agent.md`.
