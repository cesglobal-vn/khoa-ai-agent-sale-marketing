...
> Cài đặt chi tiết nằm ở file riêng: [huong-dan-cai-dat.md](../tai-lieu-hoc-vien/huong-dan-cai-dat.md). Bài soạn này không lặp lại phần đó.
...
|---|---|---|---|---|
| K0 | 08:00 - 08:15 | 15 | Mở đầu, kiểm tra cài đặt, tạo thư mục làm việc, ra đề bài | Giảng 5 + học viên thao tác 6 + học viên gõ file 4 |
| K1 | 08:15 - 08:40 | 25 | Lý thuyết 4 tầng + demo so sánh có và không có ngữ cảnh | Giảng 15 + demo 10 |
| K2 | 08:40 - 09:05 | 25 | Tầng 1 viết CLAUDE.md, tầng 3 bật Memory | Giảng 3 + demo làm theo 7 + thực hành 15 |
| Giải lao | 09:05 - 09:15 | 10 | Nghỉ | |
| K3 | 09:15 - 09:55 | 40 | Tầng 2 viết Skill đầu tiên, chạy thật, sửa 1 vòng | Giảng 2 + demo làm theo 5 + thực hành 33 |
| K4 | 09:55 - 10:20 | 25 | Tầng 4 nối MCP đọc dữ liệu thật | Giảng 7 + demo làm theo 6 + thực hành 12 |
| K5 | 10:20 - 10:30 | 10 | Tổng kết, bài tập, mở đường Buổi 2 | Giảng 10 |

**Cộng lại để tự kiểm:** 15 + 25 + 25 + 10 + 40 + 25 + 10 = **150 phút**, khớp thời lượng khai báo.

**Tay học viên đặt trên bàn phím:** K0 10 phút, K2 22 phút, K3 38 phút, K4 18 phút. Cộng 88 phút trên 140 phút học thật, tức 62,9 phần trăm. Con số này chỉ đúng khi ba khối demo của K2, K3, K4 chạy đúng kiểu làm theo, tức học viên gõ cùng lúc chứ không ngồi xem. Giảng viên bấm nhanh cho kịp giờ là tỉ lệ tụt ngay xuống dưới ngưỡng.

**Mốc phải bám cứng:** 08:40 xong lý thuyết. 09:55 xong K3.
...
### HOẠT ĐỘNG HỌC VIÊN, GÕ THẲNG VÀO FILE (4 phút)

**Đề bài:** Mỗi người gõ thẳng vào một file trong thư mục làm việc: 3 đầu việc nội dung hoặc bán hàng mà mình phải làm đi làm lại hàng tuần.

Đề bài và tiêu chí giữ nguyên như cũ. Chỉ đổi chỗ ghi: trước đây viết tay ra giấy, giờ gõ vào file. Đổi để học viên được thao tác tạo file lần đầu ngay phút thứ 11, thay vì phải chờ tới K2.

**Cách giảng viên đọc đề:** "Anh chị không cầm bút. Anh chị gõ vào ô nhập của tab Code đúng câu tôi đọc sau đây, rồi tự điền ba việc của mình vào. Ba đầu việc mà tuần nào anh chị cũng phải làm lại, liên quan tới nội dung hoặc bán hàng. Mỗi việc một dòng, không cần dài. Ví dụ: viết bài bán hàng cho Facebook, trả lời tin nhắn hỏi giá, soạn email chào sỉ cho spa, viết kịch bản video ngắn, dựng caption cho ảnh sản phẩm. Anh chị có 4 phút."
...
Nội dung file gồm đúng 3 dòng, mỗi dòng là một đầu việc nội dung hoặc bán hàng
mà tuần nào tôi cũng phải làm lại:

1. [gõ việc thứ nhất của anh chị vào đây]
2. [gõ việc thứ hai vào đây]
3. [gõ việc thứ ba vào đây]

Chỉ tạo file, chưa phân tích gì cả. Tạo xong đọc lại nội dung file cho tôi xem.
```

**Nói với lớp ngay sau khi file hiện ra:** "Anh chị vừa tạo file đầu tiên bằng cách bảo Claude tạo. Không mở Notepad, không nhớ chỗ Save as, không lo lưu nhầm đuôi. Đây là cách cả buổi hôm nay anh chị tạo file."

**Giảng viên đi hỗ trợ:** đi một vòng, liếc màn hình từng người đọc nội dung file `viec-lap-lai.md`, vừa đi vừa hỏi nhỏ "việc này tuần làm mấy lần?" để lọc ra việc tần suất cao. Ghi lên bảng 3 việc phổ biến nhất mà nhiều người cùng nêu.

**Tiêu chí coi là xong:** mỗi máy có file `viec-lap-lai.md` trong thư mục làm việc, mở ra thấy đủ 3 dòng; và trên bảng có đúng 3 việc, mỗi việc có ít nhất 3 người trong lớp cũng làm. Nói rõ với lớp: đây là đề bài chính thức của K3, lát nữa anh chị viết skill cho một trong ba việc này.
...
- **Lớp gõ chậm hoặc ngại nghĩ đề:** giảng viên đọc luôn 5 ví dụ ở trên và nói "anh chị chỉ cần chép lại cái nào đúng với mình, thêm 1 việc riêng nữa là được".
- **Có người chưa tạo được file `viec-lap-lai.md`:** đây là dấu hiệu thư mục làm việc chưa mở đúng bằng tab Code, xử lý ngay tại đây chứ đừng để tới K2. Bảo họ gõ `Bạn đang mở thư mục nào?` để kiểm lại. Vẫn không được thì ghép cặp, và ghi tên để trợ giảng xử lý giờ nghỉ.
...
## K1. LÝ THUYẾT: BỐN TẦNG NGỮ CẢNH VÀ NĂNG LỰC (25 phút, 08:15 - 08:40)

**Mục tiêu khối:** học xong khối này học viên đủ vốn để làm K2, K3, K4 mà không phải dừng lại hỏi thêm.

**Cách giữ lớp tỉnh:** khối này chia 4 phần nhỏ, mỗi phần 2 đến 6 phút, cuối mỗi phần có 1 câu hỏi nhanh cho lớp. Demo đặt cuối khối để kéo lại chú ý trước khi vào thực hành.

**Cộng thời lượng khối:** 6 + 3 + 4 + 2 + 10 = **25 phút**.

**Lưu ý nhịp, đọc trước khi giảng:** khối này đã rút từ 30 xuống 25 phút, 5 phút rút ra dồn sang K3 để học viên có thêm thời gian gõ. Nội dung giảng giữ nguyên đủ 4 phần, chỉ đi nhanh hơn: mỗi phần bám sát bảng và bốn câu chốt, không kể thêm ví dụ ngoài bài. **Mười phút demo so sánh ở cuối khối tuyệt đối không rút**, đó là phần đắt nhất của cả buổi. Trễ giờ thì cắt bớt phần bình luận mở rộng ở Phần 1 và Phần 4, không cắt demo.

---

### Phần 1. Bốn tầng (6 phút)
...
### Phần 2. Cơ chế skill chạy 4 bước (3 phút)
...
### Phần 3. Cấu trúc file SKILL.md (4 phút)
...
### Phần 4. Ba nguyên tắc chống bịa (2 phút)
...
3. Nói câu chốt: "Cùng một Claude. Cùng một người gõ. Khác nhau duy nhất ở chỗ có ngữ cảnh hay không. Hai mươi lăm phút vừa rồi anh chị đã hiểu ngữ cảnh là gì. Một trăm phút còn lại chúng ta tự tay dựng nó, và từ đây trở đi anh chị gõ cùng lúc với tôi."
...
## K2. TẦNG 1 VIẾT CLAUDE.md VÀ TẦNG 3 BẬT MEMORY (25 phút, 08:40 - 09:05)
...
### THAO TÁC DEMO LÀM THEO (7 phút)

**Đây KHÔNG phải demo ngồi xem. Cả bảy phút này học viên gõ cùng lúc trên máy mình.** Bảy phút này được tính vào cột tay trên bàn phím, và chỉ được tính khi lớp gõ thật.

**Câu dặn đọc lên trước khi gõ chữ đầu tiên:** "Anh chị mở máy ra, đặt tay lên bàn phím. Bảy phút tới tôi gõ gì thì anh chị gõ y hệt trên máy mình, không ngồi nhìn. Tôi đi chậm hơn bình thường và tôi sẽ dừng lại chờ. Ai chưa kịp thì giơ tay ngay, đừng để tôi chạy tiếp rồi anh chị mất luôn khúc sau."

**Học viên gõ gì song song, ghi rõ để giảng viên nói ra thành lời:**

| Giảng viên làm | Học viên làm cùng lúc trên máy mình |
|---|---|
| Dán PROMPT 3 vào máy giảng viên | Dán đúng PROMPT 3 đó vào máy mình từ phiếu copy prompt, bấm Enter |
| Mở file `CLAUDE.md` vừa tạo, đọc to 3 phần | Mở file `CLAUDE.md` của chính mình, dò theo từng phần giảng viên đọc |
| Gõ câu hỏi kiểm tra ở Bước 2 | Gõ đúng câu đó vào máy mình |
| Dán PROMPT 4 thử phép chống bịa ở Bước 3 | Dán PROMPT 4 vào máy mình, so kết quả máy mình với màn hình lớn |

**Ba điểm dừng bắt buộc, không được bỏ:**

1. **Sau khi dán PROMPT 3:** dừng, hỏi "ai đã thấy file `CLAUDE.md` hiện ra trong thư mục thì giơ tay". Chờ tới khi tối thiểu hai phần ba lớp giơ tay rồi mới đi tiếp.
2. **Trước khi đọc to 3 phần lõi:** dừng, nói "anh chị mở file của chính mình ra, tôi đọc tới đâu anh chị dò tới đó trên máy mình".
3. **Sau khi dán PROMPT 4:** dừng, hỏi "trên máy anh chị nó trả lời 'chưa đủ dữ liệu' mấy trên ba câu?". Đếm nhanh bằng cách giơ tay. Máy nào ra khác máy giảng viên thì đó là tình huống dạy được, xử lý theo mục DỰ PHÒNG bên dưới.

**Nếu lớp tụt lại quá xa:** dừng hẳn, để trợ giảng đi gỡ, thà mất một phút chờ còn hơn cả lớp mất bảy phút. Đây là quy tắc cứng: **thà chạy chậm mà cả lớp gõ, còn hơn chạy đúng giờ mà nửa lớp ngồi xem.**

#### Bước 1 (3 phút): dựng CLAUDE.md, cả lớp gõ cùng

1. Mở Claude Desktop, tab Code, mở thư mục demo có sẵn `san-pham-thao-an.md`. Nhắc lớp mở đúng thư mục `thao-an-marketing` của mình.
2. Dán PROMPT 3 (nội dung đầy đủ ở phần thực hành bên dưới), bấm Enter. **Nói to: "anh chị dán cùng tôi, bấm Enter cùng tôi."**
3. Khi Claude báo đã tạo file, mở thư mục trên màn hình nền cho lớp thấy file `CLAUDE.md` vừa xuất hiện. Nói: "Anh chị thấy chưa, tôi không mở Notepad lần nào. Trên máy anh chị cũng vậy, kiểm giúp tôi, ai thấy file rồi thì giơ tay." **Điểm dừng 1, chờ hai phần ba lớp.**
4. Mở file ra, chiếu nội dung, dừng lại đọc to 3 phần quan trọng nhất. **Điểm dừng 2: bảo cả lớp mở file của chính mình ra dò song song.**
...
#### Bước 2 (2 phút): cả lớp cùng kiểm Claude đọc được file

1. Gõ một câu ngắn vào ô nhập, và bảo cả lớp gõ đúng câu đó trên máy mình: `Thảo An cấm dùng những từ nào, và gọi khách hàng bằng gì?`
2. Chiếu kết quả. Hỏi lớp: "trên máy anh chị nó có nhắc đúng danh sách từ cấm không?"
3. Nói: "Nó nhắc lại đúng danh sách từ cấm và đúng cách xưng hô. Từ giờ mọi việc tôi giao trong thư mục này, nó đều đọc cái này trước. Tôi không phải dán lại lần nào nữa. Máy anh chị cũng vậy, vì file nằm trong thư mục của anh chị chứ không phải của tôi."

#### Bước 3 (2 phút): THỬ PHÉP CHỐNG BỊA, cả lớp chạy trên máy mình

Nói trước khi gõ: "Giờ tới đoạn tôi hứa với anh chị ở khối trước. Tôi sẽ hỏi nó ba con số mà hồ sơ Thảo An ghi rõ là chưa có. Anh chị dán cùng tôi và nhìn kỹ máy của chính mình, vì rất có thể máy anh chị ra khác máy tôi. Chỗ khác nhau đó mới là chỗ đáng học."

1. Dán PROMPT 4, bấm Enter. Cả lớp dán cùng.
2. Chiếu kết quả, đọc to từng câu trả lời. **Điểm dừng 3: hỏi cả lớp "máy anh chị trả 'chưa đủ dữ liệu' mấy trên ba câu?", đếm bằng giơ tay.**
...
## K3. TẦNG 2 VIẾT SKILL ĐẦU TIÊN (40 phút, 09:15 - 09:55)

**Khối này đã được cộng thêm 5 phút lấy từ K1**, vì đây là sản phẩm chính học viên mang về. Cộng lại: giảng 2 + demo làm theo 5 + thực hành 33 = 40 phút.
...
*(Chiếu lại khung frontmatter và khung 6 phần từ K1 lên màn hình và ĐỂ NGUYÊN đó suốt 33 phút thực hành, đừng tắt đi.)*

"33 phút thực hành chia 4 chặng, tôi bấm giờ báo chuyển chặng. Chặng một 13 phút: nhờ Claude viết skill. Chặng hai 10 phút: chạy skill đó ra 3 bài bán hàng thật. Chặng ba 5 phút: chạy tiếp ra 10 hook và 10 CTA. Chặng bốn 5 phút: nhờ chính Claude soi lại skill của mình và sửa. Nhắc lại đường dẫn, anh chị nhìn lên màn hình: skill là một THƯ MỤC nằm ở `.claude/skills/`, bên trong có file tên đúng là `SKILL.md`. Anh chị không phải tự tạo mấy thư mục lồng nhau đó, cứ bảo Claude tạo, nó tạo hết."

### THAO TÁC DEMO LÀM THEO (5 phút)

**Năm phút này học viên gõ cùng lúc, không ngồi xem.** Đây là khối demo dễ bị bỏ nhất vì giảng viên đã trễ giờ tới đây, nhưng bỏ là học viên bước vào 33 phút thực hành mà chưa từng thấy skill chạy trên máy mình.

**Câu dặn đọc lên trước khi gõ:** "Anh chị đặt tay lên bàn phím lại. Năm phút này tôi gõ gì anh chị gõ nấy. Tôi đi chậm, và tôi dừng hai lần để chờ cả lớp."

**Học viên gõ gì song song:**

| Giảng viên làm | Học viên làm cùng lúc trên máy mình |
|---|---|
| Dán PROMPT 6 | Dán đúng PROMPT 6 vào máy mình, bấm Enter |
| Gõ `Cho tôi xem nội dung file SKILL.md vừa tạo.` | Gõ đúng câu đó, mở file skill của chính mình ra đọc |
| Gõ yêu cầu cố ý thiếu ở Bước 2 | Gõ đúng yêu cầu thiếu đó, xem máy mình có hỏi ngược lại không |
| Gõ câu sửa skill ở Bước 3 | Chưa gõ, chỉ nhìn. Chặng 4 lát nữa họ tự làm phần sửa trên skill của mình |

**Hai điểm dừng bắt buộc:**

1. **Sau khi dán PROMPT 6:** dừng, hỏi "ai đã thấy Claude báo tạo xong file `SKILL.md` thì giơ tay". Chờ hai phần ba lớp. Máy nào chưa ra thì trợ giảng tới ngay, vì cả 33 phút sau dựa vào file này.
2. **Sau khi gõ yêu cầu cố ý thiếu:** dừng, hỏi "trên máy anh chị nó có hỏi ngược lại đủ bốn thông tin đầu vào không, hay nó viết luôn?". Ai bảo nó viết luôn thì đó là dấu hiệu dòng `description` hoặc bước 1 trong skill viết chưa chặt, ghi tên lại để đi gỡ trong chặng 1.

#### Bước 1 (2 phút): dựng skill, cả lớp gõ cùng

1. Dán PROMPT 6 (nội dung đầy đủ ở phần thực hành bên dưới), bấm Enter. **Nói to: "dán cùng tôi."**
2. Khi Claude báo xong, gõ: `Cho tôi xem nội dung file SKILL.md vừa tạo.` **Điểm dừng 1, chờ hai phần ba lớp giơ tay.**
3. Chiếu nội dung, dừng lâu nhất ở đúng 2 chỗ. Bảo lớp mở file của chính mình ra dò song song.
...
#### Bước 2 (2 phút): chạy thử và cố tình bỏ trống thông tin, cả lớp gõ cùng

1. Gõ một yêu cầu CỐ Ý thiếu, và bảo cả lớp gõ đúng câu đó: `Dùng skill viet-bai-ban-hang viết cho tôi một bài.`
2. Chỉ vào màn hình khi Claude hỏi ngược lại bốn thông tin đầu vào: "Anh chị thấy chưa, nó không tự đoán. Nó hỏi lại tôi viết cho SKU nào, đăng kênh nào. Vì tôi đã viết trong quy trình rằng bước 1 phải kiểm tra đủ đầu vào. Đây chính là thứ giúp anh chị yên tâm giao việc cho nó." **Điểm dừng 2: hỏi cả lớp máy mình có hỏi ngược lại đủ bốn thông tin không.**
...
### HOẠT ĐỘNG HỌC VIÊN (33 phút)

Cộng lại: 13 + 10 + 5 + 5 = **33 phút**.

Ai có thương hiệu thật thì làm cho thương hiệu mình. Ai chưa có thì làm trên Thảo An. Ai muốn làm skill cho một trong ba việc đã gõ vào file `viec-lap-lai.md` ở K0 thì đổi phần "việc cần chuẩn hóa" trong prompt, giữ nguyên phần còn lại.

#### Chặng 1 (13 phút): nhờ Claude viết file SKILL.md
...
#### Chặng 3 (5 phút): 10 hook và 10 CTA
...
- **Hết 13 phút chưa xong chặng 1:** cho họ dùng luôn bản Claude vừa trả, không sửa gì, chuyển ngay sang chặng 2. Thà chạy thử được một bản chưa hoàn hảo còn hơn ngồi mãi ở chặng 1.
...
- **Người làm quá nhanh, xong sớm 5 phút:** giao thêm việc: viết thêm mục "Khi nào KHÔNG dùng skill này" vào cuối file, liệt kê 2 tình huống dễ nhầm. Hoặc viết skill thứ hai cho một việc khác trong file `viec-lap-lai.md` của họ.
...
### THAO TÁC DEMO LÀM THEO (6 phút)

**Sáu phút này học viên thao tác cùng lúc trên máy mình.** Khối này có phần bấm chuột trong Settings nhiều hơn phần gõ, nên đi càng phải chậm.

**Câu dặn đọc lên trước khi bấm:** "Anh chị mở Settings của Claude Desktop ra, để nguyên đó. Sáu phút này tôi bấm tới đâu anh chị bấm tới đó. Có một chỗ tôi sẽ bảo anh chị DỪNG TAY và không bấm, đó là màn hình cấp quyền của Google. Chỗ đó chờ tôi nói xong đã."

**Học viên làm gì song song:**

| Giảng viên làm | Học viên làm cùng lúc trên máy mình |
|---|---|
| Mở Settings, tìm mục Connectors | Mở Settings, tìm mục Connectors trên máy mình |
| Chọn Google Drive, bấm kết nối | Chọn Google Drive, bấm kết nối |
| Dừng ở màn hình cấp quyền, đọc to từng dòng quyền | **Dừng tay, KHÔNG bấm gì.** Đọc theo danh sách quyền trên máy mình |
| Bấm Cho phép trên tài khoản demo | **Vẫn chưa bấm.** Phần bấm cấp quyền để dành cho Việc 1 của phần thực hành, sau khi trợ giảng đã đi kiểm từng máy |
| Mở trang quản lý tài khoản Google, chỉ chỗ gỡ quyền | Mở đúng trang đó trên trình duyệt máy mình, tìm thấy chỗ gỡ quyền |
| Dán PROMPT 10 ở Bước 2 | Chưa dán, vì chưa cấp quyền. Đọc theo prompt trên phiếu copy, đối chiếu kết quả trên màn hình lớn |

**Hai điểm dừng bắt buộc:**

1. **Ngay khi màn hình cấp quyền của Google hiện ra:** dừng, nói to "cả lớp bỏ tay khỏi chuột". Đọc hết danh sách quyền rồi mới cho đi tiếp. Đây là điểm dừng an toàn dữ liệu, không phải điểm dừng kỹ thuật, tuyệt đối không bỏ.
2. **Sau khi chỉ chỗ gỡ quyền trên trang tài khoản Google:** dừng, hỏi "ai đã mở được đúng trang đó và tìm thấy dòng gỡ quyền thì giơ tay". Chờ hai phần ba lớp. Ai chưa tìm được thì cầm tờ hướng dẫn in giấy dò theo.
...
#### Bước 1 (3 phút): nối Google Drive, cả lớp bấm theo tới đúng màn hình cấp quyền
...
**Số liệu để giảng viên đối chiếu nhanh** (bộ số này đã khớp sẵn với file [thao-an-don-hang-demo.csv](../demo/thao-an/assets/thao-an-don-hang-demo.csv), chỉ cần tải file đó lên Google Sheet là dùng được, không phải tự dựng):
...
- [ ] Gửi học viên file [huong-dan-cai-dat.md](../tai-lieu-hoc-vien/huong-dan-cai-dat.md) kèm hạn chót cài đặt, yêu cầu: cài Claude Desktop từ claude.ai/download, đăng nhập được, bấm thấy tab Code, cài Git for Windows từ git-scm.com.
...
- [ ] Đã tải file [thao-an-don-hang-demo.csv](../demo/thao-an/assets/thao-an-don-hang-demo.csv) lên Drive lớp, mở bằng Google Sheet, đặt tên đúng `thao-an-don-hang-demo` và để trong thư mục `LOP-AI-MARKETING`. File này đã có sẵn đúng 5 cột khớp PROMPT 10 và bộ số khớp phần đối chiếu ở K4, chỉ cần tải lên, không phải gõ tay.
...
- [ ] Phiếu copy 11 prompt in giấy (PROMPT 0 tới PROMPT 10), đủ mỗi người 1 bản cộng 5 bản dự phòng.
...
- [ ] File [huong-dan-cai-dat.md](../tai-lieu-hoc-vien/huong-dan-cai-dat.md) in giấy, phát cho ai chưa cài xong.
- [ ] Hướng dẫn gỡ quyền Google in giấy, phát cho cả lớp ở K4 dù họ có nối hay không.
- [ ] Giấy trắng và vở phát cho học viên ghi chép ở K1. K0 không còn viết tay, học viên gõ thẳng vào file `viec-lap-lai.md`.
...
| Tình huống | Xử lý ngay |
|---|---|
| Lớp mất tập trung giữa K1 (25 phút lý thuyết) | Dừng lại, hỏi một câu về nghề chứ không phải về AI, ví dụ "ở đây ai đang phải viết bài cho quá ba kênh cùng lúc?". Kéo lại rồi giảng tiếp. |
| Demo làm theo bị đứt nhịp, quá nửa lớp tụt lại | Dừng hẳn tay, không gõ tiếp. Đọc lại prompt vừa dán, chờ đủ 60 giây, hỏi "ai đã ra kết quả thì giơ tay". Dưới hai phần ba lớp giơ tay thì gọi trợ giảng đi gỡ cho nhóm tụt lại trước khi đi bước sau. Bỏ qua điểm dừng này là hỏng cả khối phía sau. |
...
- **Toàn bộ 11 prompt trong bài soạn này (PROMPT 0 tới PROMPT 10) phải khớp nguyên văn với phiếu copy prompt phát cho học viên.** Không tự sửa lời prompt trước lớp. Cần sửa thì sửa đồng thời ở cả bài soạn, phiếu copy và bản mềm trên Drive lớp.
- **Ba khối demo của K2, K3, K4 là demo làm theo, không phải demo ngồi xem.** Đây là điều kiện để buổi 1 đạt ngưỡng thực hành 60 phần trăm. Giảng viên bấm nhanh cho kịp giờ thì 18 phút demo chuyển ngược sang cột lý thuyết và buổi tụt xuống dưới ngưỡng. Trễ giờ thì cắt nội dung theo mục ƯU TIÊN KHI THIẾU GIỜ, đừng cắt bằng cách bấm nhanh hơn.
