...
**File đi kèm:** [../so-tay-giang-vien/buoi-06-claude-skill-va-playbook.md](../so-tay-giang-vien/buoi-06-claude-skill-va-playbook.md) · [../workbook/buoi-06-claude-skill-va-playbook.md](../workbook/buoi-06-claude-skill-va-playbook.md) · [../demo/buoi-06/skill-dong-goi-va-playbook.md](../demo/buoi-06/skill-dong-goi-va-playbook.md)
...
| **2. Demo thật, kiểu làm theo** | 35 phút | Chạy nguyên [../so-tay-giang-vien/buoi-06-claude-skill-va-playbook.md](../so-tay-giang-vien/buoi-06-claude-skill-va-playbook.md) trên case Thảo An. Có đoạn thử Skill trên yêu cầu mới, đây là phần quan trọng nhất, nhắc lớp nhìn kỹ. **Học viên gõ cùng lúc: 25 phút học viên tay trên bàn phím, 10 phút giảng viên nói và chỉ chỗ.** Xem mục "Khối 2 chạy kiểu làm theo" bên dưới. |
| **3. Làm sản phẩm, chặng 1** | 30 phút | Học viên mở [../workbook/buoi-06-claude-skill-va-playbook.md](../workbook/buoi-06-claude-skill-va-playbook.md). 14 phút gom tài sản 5 buổi (chặng 1 workbook); 16 phút viết Skill, tức bước 1 tới bước 4 của chặng 2 workbook. Giảng viên đi vòng, nhắc mốc thời gian mỗi 15 phút. |
| **Giải lao** | **10 phút** | Nghỉ. Bắt buộc, không gộp vào khối khác. Cho nghỉ đúng sau khi file Skill đã sinh ra, trước khi vào phần thử Skill. Giảng viên dùng 10 phút này gỡ cho máy nào chưa sinh được Skill, vì cả phần sau dựa vào nó. |
| **3. Làm sản phẩm, chặng 2** | 25 phút | 8 phút thử Skill trên yêu cầu mới (bước 5 của chặng 2 workbook); 17 phút viết Playbook và kế hoạch 14 ngày (chặng 3 workbook). |
...
> **Lưu ý cho giảng viên:** con số phút ghi trong tiêu đề từng chặng của workbook (18, 29, 18) tính theo nhịp cũ chưa có giải lao, cộng lại là 65 phút. Nhịp mới cho 55 phút gõ, chia hai chặng như bảng trên. Bám bảng trên. Ai không kịp thì áp mức đạt tối thiểu: **Playbook rút xuống 2 trang đủ 4 câu trả lời bắt buộc, kế hoạch rút xuống 7 ngày.** Đừng cắt phần thử Skill trên yêu cầu mới, đó là cách đo mục tiêu 6.2.
...
> "Buổi cuối rồi, anh chị mở hết ra: thư mục làm việc, `CLAUDE.md`, và tài sản của cả năm buổi trước. Đặt tay lên bàn phím. Ba mươi lăm phút tới tôi gõ gì thì anh chị gõ y hệt, và gõ trên bộ tài sản của chính anh chị chứ không phải của Thảo An. Tôi đi chậm, và sau mỗi bước lớn tôi dừng lại hỏi ai chưa ra kết quả."

**Học viên gõ gì song song:**

| Giảng viên làm | Học viên gõ cùng lúc trên máy mình |
|---|---|
| Gom tài sản 5 buổi vào cấu trúc thư mục | Gom tài sản của chính mình, tạo đúng 8 thư mục, đổi tên file |
| Rút quy trình đang làm bằng tay thành các bước | Rút quy trình của chính mình, gõ thẳng vào file |
| Viết tiêu chuẩn đầu ra bằng số và ranh giới không được vượt | Viết tiêu chuẩn của chính mình. Ai viết "viết cho hấp dẫn" thì sửa ngay tại chỗ thành câu đếm được |
| Sinh Skill hoàn chỉnh | Sinh Skill của chính mình |
| Thử Skill trên một yêu cầu chưa từng làm | Thử Skill của mình trên đúng đề chưa từng chạy đó. **Đây là phần quan trọng nhất buổi, không ai được ngồi xem ở đoạn này** |
| Chốt và giao việc cho khối 3 | Không gõ. Đây thuộc phần 10 phút giảng viên nói |

**Bốn điểm dừng bắt buộc:**

1. **Sau khi gom tài sản:** "Tôi đọc tên 3 tài sản bất kỳ, anh chị mở được cả 3 file trong 10 giây không?" Mở không được thì cấu trúc thư mục chưa đạt, sửa ngay.
2. **Sau khi viết tiêu chuẩn đầu ra:** "Đọc to tiêu chuẩn của anh chị lên. Có câu nào không đếm được không?" Câu kiểu "viết cho hấp dẫn" là chưa đạt, sửa tại chỗ trước khi đi tiếp.
3. **Sau khi Skill sinh ra:** "Ai chưa thấy file Skill hiện ra thì giơ tay." Điểm dừng dài nhất, chờ tới 90 giây. Không có Skill thì cả chặng 2 và cả phần nộp đều hụt.
4. **Sau khi thử Skill trên yêu cầu mới:** "Kết quả trên máy anh chị có đối chiếu đúng bảng tiêu chuẩn đầu ra do chính anh chị viết không?" Đếm bằng giơ tay. Ai không đạt thì đó là dấu hiệu tiêu chuẩn viết chưa đo được, quay lại sửa Skill chứ không sửa kết quả.

**Quy tắc cứng:** thà chạy chậm mà cả lớp gõ, còn hơn chạy đúng giờ mà nửa lớp ngồi xem. Thiếu giờ thì rút phần gom tài sản trong demo, tuyệt đối không rút phần thử Skill trên yêu cầu mới.
