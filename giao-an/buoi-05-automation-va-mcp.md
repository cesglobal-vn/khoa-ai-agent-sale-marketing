...
**File đi kèm:** [../so-tay-giang-vien/buoi-05-automation-va-mcp.md](../so-tay-giang-vien/buoi-05-automation-va-mcp.md) · [../workbook/buoi-05-automation-va-mcp.md](../workbook/buoi-05-automation-va-mcp.md) · [../tai-lieu-hoc-vien/buoi-05-luong-post-bai.md](../tai-lieu-hoc-vien/buoi-05-luong-post-bai.md) · [../demo/buoi-05/skill-automation-orchestrator.md](../demo/buoi-05/skill-automation-orchestrator.md)
...
| **2. Demo thật, kiểu làm theo** | 35 phút | Chạy [../so-tay-giang-vien/buoi-05-automation-va-mcp.md](../so-tay-giang-vien/buoi-05-automation-va-mcp.md) trên case Thảo An. Vẽ map, dựng bảng lead, chạy trọn luồng post bài, rồi diễn cảnh bỏ bước duyệt. **Học viên gõ cùng lúc: 25 phút học viên tay trên bàn phím, 10 phút giảng viên nói và chỉ chỗ.** Xem mục "Khối 2 chạy kiểu làm theo" bên dưới. |
| **3. Làm sản phẩm, chặng 1** | 30 phút | Học viên mở [../workbook/buoi-05-automation-va-mcp.md](../workbook/buoi-05-automation-va-mcp.md): bước 1 liệt kê việc lặp lại và chấm điểm (6 phút), bước 2 vẽ automation map (6 phút), bước 3 dựng bảng quản lý (18 phút). |
| **Giải lao** | **10 phút** | Nghỉ. Bắt buộc, không gộp vào khối khác. Cho nghỉ đúng sau khi bảng quản lý đã dựng xong, trước khi vào phần nối luồng. Giảng viên dùng 10 phút này gỡ cho máy nào chưa dựng được bảng. |
| **3. Làm sản phẩm, chặng 2** | 25 phút | Bước 4 nối và chạy luồng (14 phút), bước 5 viết mẫu thông báo (4 phút), bước 6 checklist kiểm soát rủi ro (7 phút). |
...
> **Lưu ý cho giảng viên:** con số phút ghi trong ngoặc ở từng bước của workbook tính theo nhịp cũ chưa có giải lao. Bám bảng trên. Ai không nối được công cụ thật thì làm prototype trên sơ đồ, vẫn tính đạt theo mục tiêu 5.3, xem mục 7 của workbook.
...
> "Anh chị mở thư mục làm việc ra, mở sẵn `lich-14-ngay.md` của buổi 4 và mở sẵn một tab Google Sheet trống. Đặt tay lên bàn phím. Ba mươi lăm phút tới tôi bấm tới đâu anh chị bấm tới đó. Buổi này có phần cấp quyền cho công cụ, nên sẽ có chỗ tôi bảo anh chị DỪNG TAY, không bấm. Chỗ đó chờ tôi nói xong đã."

**Học viên gõ gì song song:**

| Giảng viên làm | Học viên làm cùng lúc trên máy mình |
|---|---|
| Vẽ automation map của Thảo An | Vẽ map của chính mình trên bảng trống trong workbook, gõ thẳng vào file `automation-map.md` |
| Dựng bảng quản lý có cột trạng thái và cột người duyệt | Dựng bảng của chính mình trên Google Sheet, Airtable hoặc Notion |
| Nối công cụ, dừng ở màn hình cấp quyền | **Dừng tay, không bấm.** Đọc theo danh sách quyền trên màn hình của mình |
| Chạy trọn luồng post bài lên kênh demo | Ai đã nối kênh demo ở nhà thì chạy trên kênh của mình. Ai chưa thì dựng prototype có đủ 5 phần: kích hoạt, xử lý, đầu ra, người duyệt, chỗ ghi log |
| Diễn cảnh bỏ bước duyệt | Không gõ. Đây thuộc phần 10 phút giảng viên nói, và là phần lớp phải nhìn kỹ |

**Bốn điểm dừng bắt buộc:**

1. **Sau khi vẽ xong map:** "Map của anh chị đã có cột 'không tự động' kèm lý do chưa?" Map chỉ ghi việc được chọn, không ghi việc bị loại, là chưa đạt. Sửa ngay tại chỗ.
2. **Ngay khi màn hình cấp quyền hiện ra:** dừng, nói to "cả lớp bỏ tay khỏi chuột". Đọc hết danh sách quyền rồi mới cho đi tiếp. Đây là điểm dừng an toàn dữ liệu, tuyệt đối không bỏ. Nhắc lại quy định cứng: **chỉ nối kênh demo hoặc kênh cá nhân, không nối fanpage công ty đang chạy thật.**
3. **Sau khi bảng quản lý nhận được dòng đầu tiên do agent ghi vào:** "Ai chưa thấy dòng mới hiện ra trong bảng của mình thì giơ tay." Chờ hai phần ba lớp.
4. **Trước khi bấm bước cuối của luồng post bài:** "Trong luồng của anh chị có điểm dừng chờ người duyệt chưa? Chỉ cho tôi đúng chỗ đó trên sơ đồ." Luồng đăng thẳng không qua người là chưa đạt, dù chạy được.

**Quy tắc cứng:** thà chạy chậm mà cả lớp gõ, còn hơn chạy đúng giờ mà nửa lớp ngồi xem. Thiếu giờ thì rút ngắn phần dựng bảng lead trong demo, không bỏ điểm dừng nào, và tuyệt đối không bỏ cảnh diễn bỏ bước duyệt.
...
Đây là luồng lõi của buổi. Đặc tả đầy đủ nằm trong [../tai-lieu-hoc-vien/buoi-05-luong-post-bai.md](../tai-lieu-hoc-vien/buoi-05-luong-post-bai.md).
...
Kết quả thật của luồng này: [../demo/thao-an/assets/images/thao-an-serum-rau-ma-fb-01.png](../demo/thao-an/assets/images/thao-an-serum-rau-ma-fb-01.png). Mở ra chiếu cho lớp xem.
...
Biểu hiện: học viên không có quyền fanpage, không mở được tài khoản Make, ngồi chờ hết cả hai chặng của khối làm sản phẩm.
